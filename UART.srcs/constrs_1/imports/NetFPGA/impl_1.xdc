...
set_property DIRECTION IN [get_ports din]
set_property IOSTANDARD LVCMOS18 [get_ports din]

set_property DIRECTION OUT [get_ports dout]
set_property IOSTANDARD LVCMOS18 [get_ports dout]
set_property DRIVE 12 [get_ports dout]
set_property SLEW SLOW [get_ports dout]

set_property PACKAGE_PIN AY19 [get_ports din]
set_property PACKAGE_PIN BA19 [get_ports dout]
